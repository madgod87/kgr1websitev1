...
const BlockProfile: React.FC = () => {
  ...
  // Block statistics
  const blockStats = [
    { label: 'Total Area', value: '420.5 km²', icon: '🗺️', color: 'blue' },
    { label: 'Population', value: '2.8 Lakh', icon: '👥', color: 'purple' },
    { label: 'Gram Panchayats', value: '15', icon: '🏛️', color: 'indigo' },
    { label: 'Villages', value: '185', icon: '🏘️', color: 'blue' },
    { label: 'Assembly Constituencies', value: '4', icon: '🗳️', color: 'purple' },
    { label: 'Schools', value: '120+', icon: '🏫', color: 'indigo' },
    { label: 'Health Centers', value: '25', icon: '🏥', color: 'blue' },
    { label: 'Banks', value: '35', icon: '🏦', color: 'purple' },
  ]
